    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_articulos_baja", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tb_articulos_baja_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_tb_articulos_liquidacion", x => x.Id);
                    table.ForeignKey(
                        name: "FK_tb_articulos_liquidacion_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_tb_articulos_baja_BookId",
                table: "tb_articulos_baja",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_tb_articulos_liquidacion_BookId",
                table: "tb_articulos_liquidacion",
                column: "BookId");
        }
